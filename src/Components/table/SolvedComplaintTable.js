...
const SolvedComplaintTable = (props) => {
  ...
  useEffect(() => {
    props.getComplaint("solved", type); // eslint-disable-next-line
  }, []);
        ...
        <div class="col-xl-6 col-md-6 col-sm-12 col-12 ">
          <div class="breadcrumb-four float-right">
            <ul class="breadcrumb">
              ...
              <li class="active">
                <a href={()=> false}>Complain Solved</a>
              </li>
            </ul>
          </div>
        </div>
...
export default connect(null, { getComplaint })(SolvedComplaintTable);
